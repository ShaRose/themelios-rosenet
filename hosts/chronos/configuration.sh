...
zfs_pool_name="chronos-pool"
zfs_pool_disks=("/dev/disk/by-id/ata-Samsung_SSD_850_PRO_256GB_S251NXAG723090T")
...
nix_top_level_configuration="hosts/chronos" # Your top-level nix file to be bootstrapped
