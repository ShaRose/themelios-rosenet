...
zfs_pool_name="helios-pool"
zfs_pool_disks=("/dev/disk/by-id/ata-OCZ-VERTEX2_3.5_OCZ-D6208364I1R733X7")
...
nix_top_level_configuration="hosts/helios" # Your top-level nix file to be bootstrapped
